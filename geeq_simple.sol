...
contract GEEQToken is ERC20Interface, Owned {
    ...
    function pauseEnable() public {
        pauseOn= true;
    }
    function pauseDisable() public {
        pauseOn= false;
    }
    function migrationEnable() public {
        migrationOn= true;
    }
    function migrationDisable() public {
        migrationOn= false;
    }
    ...
    function burn(uint256 tokens) public {      //works even if contract is paused
